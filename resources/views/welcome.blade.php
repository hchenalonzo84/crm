    ...
    <body class="antialiased">
        ...
        <header id="header">
            <div class="container__header">
                <div class="logo">
                    <img src="images/alternaLogo.png" alt="">
                </div>
        ...
        <div class="container_all" id="container__all">
            ...
            <div class="body__Page">
                <div class="container__article">
                    <div class="box__article"><img src="./images/mayabbatzibal.jpg" alt=""></div>
            ...
            <Footer>
                ...
                <div class="box__copyright">
                    <hr>
                    <p>Todos los derechos reservados © 2022 <b>Alterna</b></p>
                </div>
            </Footer>
